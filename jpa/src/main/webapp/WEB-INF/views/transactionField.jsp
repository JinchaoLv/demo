...
<div>
    ...
    <span style="font-size: 20px; font-weight: bold">交易类型</span>
...
<table class="transactionTable">
    ...
    <c:forEach items="${transaction_fields}" var="field">
        <tr>
            <td class="transactionTd">${field.id}</td>
            <td class="transactionTd">${field.name}</td>
            <td class="transactionTd">
                <a href="${pageContext.request.contextPath}/transaction/field/delete/${field.id}">删除</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">新增交易类型</h4>
            </div>
            <div class="modal-body">
                <div>
                    <form id="form-add" action="${pageContext.request.contextPath}/transaction/field/add">
                        交易类型：<input id="field" type="text" name="field"/>
                    </form>
                </div>
            </div>
